...
export default function NavBar() {
  const wallet = useWallet();
    // Use state to store the wallet status
  const [walletStatus, setWalletStatus] = useState(wallet.status);

    // Use useEffect to update the wallet status when it changes
    useEffect(() => {
        ...
        <Container as={Flex} maxW={"7xl"} align={"center"}>
          <Flex flex={{ base: 1 }} justify="start" ml={{ base: -2, md: 0 }}>
            ...
            >
              ...
              >
                <NextLink href="/">🤝QuantaCrowd</NextLink>
              </Box>
            </Heading>
          </Flex>
          <Stack
